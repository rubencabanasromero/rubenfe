...
Route::resource('estacion', \App\Http\Controllers\EstacionController::class);
...
Route::resource('misbilletes',\App\Http\Controllers\MisbilletesController::class)->middleware(['auth', 'verified']);
